...
SELECT *               
FROM students
WHERE age BETWEEN 35 AND 45 LIMIT 10;
...
SELECT * FROM students
 ...
 ORDER BY id ASC,first_name DESC LIMIT 10 OFFSET 20;
...
SELECT * FROM students 
WHERE age = 50 AND last_name LIKE '%n%';
...
--Select all the products that are on sale and have remaining items in stock 
